...
var userRegister = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, name, email, password, emailExists, userHashPassword, user, savedUser, selectedUser, payload, token;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 16:
          userHashPassword = _context.sent;
          user = new UserModel({
            name: name,
            email: email,
        ...
        case 20:
          ...
          _context.next = 23;
          return UserModel.findById(savedUser._id).select('name email');
        case 23:
...
var userLogin = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$body2, email, password, userExists, user, payload, token;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 4:
          ...
          _context2.t0 = !userExists;
          if (_context2.t0) {
            _context2.next = 10;
            break;
          }
          _context2.next = 9;
          return verifyPassword(password, userExists.password);
        case 9:
        ...
        case 14:
          _context2.next = 16;
          return UserModel.findById(userExists._id).select('name email');
        case 16:
          user = _context2.sent;
          payload = {
            _id: user._id,
...
var userSynchronize = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var _id, user, payload, token;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _id = req.user._id;
          _context3.next = 4;
          return UserModel.findById(_id).select('name email');
        case 4:
          user = _context3.sent;
          if (user) {
            _context3.next = 9;
  ...
  return function userSynchronize(_x5, _x6) {
...
module.exports = {
  ...
  userLogin: userLogin,
  userSynchronize: userSynchronize
};